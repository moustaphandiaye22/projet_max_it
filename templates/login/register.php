...
$errors['prenom'])): ?>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="tel" name="numero_telephone" placeholder="Enter telephone" value="<?= htmlspecialchars(isset($old['numero_telephone']) ? $old['numero_telephone'] : '') ?>" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent" >
                    ...
                    <div>
                        ...
                        <input type="text" name="numero_carte_identite" placeholder="Enter CNI" value="<?= htmlspecialchars(isset($old['numero_carte_identite']) ? $old['numero_carte_identite'] : '') ?>" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent" >
                ...
                <div>
                    ...
                    <input type="text" name="adresse" placeholder="Enter votre adresse" value="<?= htmlspecialchars(isset($old['adresse']) ? $old['adresse'] : '') ?>" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent" >
